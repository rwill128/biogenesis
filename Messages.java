 ...
 * Portuguese translation by MaurяПНcio Leonardi
...
public class Messages {
	 ...
	 */
	private static final String[] supportedLocalesCodes = {"ca","en","es","de","pt","ru"}; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
	/**
